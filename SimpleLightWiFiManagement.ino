...
char ssid[] = "Chelovek";      //  your network SSID (name)
char pass[] = "gbkbcjc4000";   // your network password
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/H\">here</a> turn the LED on pin 9 off<br>");
            client.print("Click <a href=\"/L\">here</a> turn the LED on pin 9 on<br>");
